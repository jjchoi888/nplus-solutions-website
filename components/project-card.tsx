  ...
  return (
    ...
    >
      ...
      <div className="flex items-end justify-between gap-5 p-6 sm:p-7">
        <div>
          <p className="mb-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-white/42">{project.eyebrow}</p>
          <h3 className="text-2xl font-semibold tracking-[-0.04em] text-white sm:text-[1.75rem]">{project.title}</h3>
          <p className="mt-3 max-w-xl text-sm leading-6 text-white/52">{project.summary}</p>
        </div>
