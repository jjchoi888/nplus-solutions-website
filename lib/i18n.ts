...
export const siteCopy = {
  en: {
    ...
    form: {
      ...
      sending: "Sending...",
      sent: "Inquiry sent",
      sentNote: "Thank you. Your inquiry has been sent to N Plus Solutions.",
      sendError: "We couldn’t send your inquiry. Please try again or email",
      note: "Your inquiry will be sent directly to N Plus Solutions.",
  ...
  ko: {
    ...
    form: {
      ...
      sending: "전송 중...",
      sent: "문의 전송 완료",
      sentNote: "감사합니다. 문의 내용이 N Plus Solutions로 전송되었습니다.",
      sendError: "문의 전송에 실패했습니다. 다시 시도하거나 다음 이메일로 보내주세요:",
      note: "문의 내용은 N Plus Solutions로 바로 전송됩니다.",
  ...
  zh: {
    ...
    form: {
      ...
      sending: "正在发送...",
      sent: "咨询已发送",
      sentNote: "感谢您。您的咨询已发送至 N Plus Solutions。",
      sendError: "咨询发送失败。请重试，或发送邮件至：",
      note: "您的咨询将直接发送至 N Plus Solutions。",
